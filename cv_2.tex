...
\moveleft.5\hoffset\centerline{60 Garden Street}
\moveleft.5\hoffset\centerline{Cambridge, MA 02138, USA}
...
%{\bf Sema High School}  \hfill Mar. 2012 - Feb. 2015 \\
%\begin{comment}
%\end{comment}
...
\begin{itemize}
    \item[] A competitive scholarship granting 30,000 USD per year for four years during a Ph.D. program. The foundation selected 6 distinguished students from all majors.% out of 184 applicants.
\end{itemize}
...
%\textit{Physics}
%\begin{itemize}
%    \item[] General Physics I \& II %(B+)  (A)
%    \item[] Classical Mechanics, Electromagnetism I \& II, Mathematical Methods of Physics, Quantum Physics I \& II, Statistical Physics\textsuperscript{\textdagger} %(B) (B+) (A+) (A+) (A+) (A+)  (A+)
%    \item[] Introduction to Optics, Advanced Quantum Physics, Solid State Physics, Basic Astronomy and the Galaxy\textsuperscript{\textdagger} % (A+) (A+) (A+) (B+)
%    \item[] General Physics Experiment I \& II, Advanced Physics Laboratory\textsuperscript{\textdagger}, Experimental Physics II % (A) (A) (A) (A+)
%\end{itemize}
%\textit{Mathematics}
%\begin{itemize}
%    \item[] Single Variable Calculus, Multivariable Calculus, Introduction to Linear Algebra, Differential Equations % (A+) (A+) (A) (A+)
%    \item[] Introduction to Probility Models\textsuperscript{\textdagger}, Abstract Algebra, Complex Analysis %  (A) (A) (A)
%\end{itemize}
...
%\begin{tabular}{rl}
%    Working knowledge of:& C\texttt{++}, C, Python, MATLAB, bash, Mathematica\\
%    Familiar with:& C shell\\
...
%\begin{itemize}
%\item[] Accepted to get student travel/accommodation support from Harvard
%\end{itemize}
